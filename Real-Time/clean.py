# -*- coding: utf-8 -*-
"""
Created on Tue Sep 18 20:33:16 2018
...
#act_num = input('Enter Activity Number: ')
...
##      plt.figure()
##      plt.grid(True)
##      plt.plot(time,acc_data[:,0],time,mod_acc[:,0])
    ...
    plt.figure()
    plt.grid(True)
    plt.plot(data[int(indx[rep1]+1):int(indx[rep2]),0],data[int(indx[rep1]+1):int(indx[rep2]),4],data[int(indx[rep1]+1):int(indx[rep2]),0],data[int(indx[rep1]+1):int(indx[rep2]),5],data[int(indx[rep1]+1):int(indx[rep2]),0],data[int(indx[rep1]+1):int(indx[rep2]),6])
#    
#    plt.figure()
#    plt.grid(True)
#    plt.plot(data[int(indx[rep1]+1):int(indx[rep2]),0],data[int(indx[rep1]+1):int(indx[rep2]),1],data[int(indx[rep1]+1):int(indx[rep2]),0],data[int(indx[rep1]+1):int(indx[rep2]),2],data[int(indx[rep1]+1):int(indx[rep2]),0],data[int(indx[rep1]+1):int(indx[rep2]),3])
#    
#    plt.figure()
#    plt.grid(True)
#    plt.plot(data[int(indx[rep1]+1):int(indx[rep2]),0],data[int(indx[rep1]+1):int(indx[rep2]),7],data[int(indx[rep1]+1):int(indx[rep2]),0],data[int(indx[rep1]+1):int(indx[rep2]),8],data[int(indx[rep1]+1):int(indx[rep2]),0],data[int(indx[rep1]+1):int(indx[rep2]),9])
