# -*- coding: utf-8 -*-
"""
Created on Sun Oct 21 15:19:12 2018
...
## SVM-1
n_comp = 80;X1 = np.zeros((0,126));y1 = np.zeros((0,0))
...
svclassifier1 = BaggingClassifier(SVC(kernel='rbf',degree=8)) #rbf
svclassifier1.fit(X_train1,y_train1)
svclassifier1.predict(X_test1)
print(svclassifier1.accuracy_score)


## SVM-2
n_comp = 80;X2 = np.zeros((0,126));y2 = np.zeros((0,0))
...
print(svclassifier2.accuracy_score)


## SVM-3
n_comp = 80;X3 = np.zeros((0,126));y3 = np.zeros((0,0))
...
print(svclassifier3.accuracy_score)


## SVM-4
n_comp = 80;X4 = np.zeros((0,126));y4 = np.zeros((0,0))
...
svclassifier4 = BaggingClassifier(SVC(kernel='poly',degree=8)) #rbf
svclassifier4.fit(X_train4,y_train4)
svclassifier4.predict(X_test4)
print(svclassifier4.accuracy_score)
